const questions = [
    
    {
        ...
        optionA: "Consumes less memory",
        optionB: "Less code and easy to implement",
        optionC: "Consumes more memory",
        optionD: "More code has to be written",
    ...
    {
        question: "What is the average case time complexity of binary search using recursion?",
        optionA: "O(nlogn)",
        optionB: "O(logn)",
        optionC: "(n)",
        optionD: "O(n2)",
    ...
    
    {
        ...
        optionA: "Brute Force technique",
        optionB: "Divide and conquer",
        optionC: "Greedy algorithm",
        optionD: "Dynamic programming",
        correctOption: "optionB"
    },
    {
        question: "What are the applications of binary search?",
        optionA: "To find the lower/upper bound in an ordered sequence",
        optionB: "Union of intervals",
        optionC: "Debugging",
